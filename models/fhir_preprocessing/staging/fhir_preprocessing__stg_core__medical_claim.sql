...
select {% if target.type == 'fabric' %} top 0 {% else %}{% endif %}
    ...
    , {{ the_tuva_project.try_to_cast_date('null', 'YYYY-MM-DD') }} as claim_line_start_date
    ...
    , {{ the_tuva_project.try_to_cast_date('null', 'YYYY-MM-DD') }} as admission_date
    , {{ the_tuva_project.try_to_cast_date('null', 'YYYY-MM-DD') }} as discharge_date
