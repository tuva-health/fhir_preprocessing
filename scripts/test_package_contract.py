...
class PackageContractTest(unittest.TestCase):
    ...
    def test_release_workflow_has_no_asset_gate_without_a_catalog(self):
        workflow_text = RELEASE_WORKFLOW.read_text()

        # This package ships no data assets. If a catalog is added later, its
        # declared files must be checked directly under the package/version path.
        ...
        self.assertNotIn("tuva-public-resources", workflow_text)
